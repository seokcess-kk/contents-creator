...
- `2026-05-06`: UX Refactor Phase 1 — Operations OS 정렬. nav 9→6 영역 (운영 홈/생성/검수·발행/성과·분석/브랜드/관리), `/` 가 운영 홈으로 승격 (`/rankings` 컨텐츠 이전), `/rankings` `/pipeline` 영구 redirect (외부 북마크/SEO 보호). 단일 작업 폼은 P4 까지 `/legacy-jobs` 임시 보존. 단일 흐름 시그니처 무변경. SPEC: `tasks/todo.md` "UX Refactor — Operations OS 정렬"
