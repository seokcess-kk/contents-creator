...
## severity 기준 (엄격히 준수)
- CRITICAL: "100% 완치", "보장", "최고", 전후사진 무허가 사용, 미인증 시술 광고 등 \
명백하고 중대한 위반만 해당. 법적 제재가 즉시 가능한 수준.
- WARNING: 문맥상 과장 가능성이 있는 표현. 수정 권장이지만 즉시 위법은 아닌 수준.
- INFO: 개선 권장 사항.

## 표준 의료 용어는 위반이 아닙니다
다음은 일반적인 의료 업무 설명이므로 위반으로 판단하지 마세요:
- "치료를 제공/시행합니다", "처방합니다", "진료합니다" (의료 행위 설명)
- "맞춤 처방", "개인별 처방" (표준 진료 방식 설명)
- "상담을 받으세요", "내원하세요" (행동 유도)
- "~에 도움이 될 수 있습니다" (가능성 표현)
